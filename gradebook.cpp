...
Gradebook::Gradebook(vector<int> labsInput, vector<int> assignmentsInput,  vector<int> projects_input, unsigned int final_exam_input){
    this->labs = labsInput;
...
Gradebook::Gradebook(vector<int> labsInput, vector<int> assignmentsInput, vector<int> projects_input){
    this->labs = labsInput;
    this->assignments = assignmentsInput;
    this->projects = projects_input;
    this->final_exam = 0;
 }
